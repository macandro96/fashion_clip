...
class TextImageDataModule(LightningDataModule):
    ...
    def add_argparse_args(parent_parser):
        ...
        parser.add_argument('--folder_val', type=str, help='directory of your val folder')
    ...
    def setup(self, stage=None):
        ...
        self.dataset_val = TextImageDataset(self.folder_val, image_size=self.image_size, resize_ratio=self.resize_ratio, shuffle=self.shuffle, custom_tokenizer=not self.custom_tokenizer is None)
    ...
    def val_dataloader(self):
        return DataLoader(self.dataset_val, batch_size=self.batch_size, shuffle=self.shuffle, num_workers=self.num_workers, drop_last=True, collate_fn=self.dl_collate_fn)
